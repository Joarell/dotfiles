...
keymap("n", "<Leader>S", ":save <c-r>% ", opts)
...
keymap("n", "<D-j>", ":cnext<CR>", opts)
keymap("n", "<D-k>", ":cprev<CR>", opts)
keymap("n", "<leader>e", vim.diagnostic.open_float, opts)
keymap("n", "<Leader>ca", vim.lsp.buf.code_action, opts)
keymap("n", "<Leader>af", vim.lsp.buf.signature_help, opts)
...
keymap("n", "<F5>", require('dap').restart, opts)
keymap("n", "<F6>", require('dapui').float_element, opts)
...
keymap("n", "TD", ":Trouble diagnostics<cr>", opts)
